        ...
        try {
            return await api.get(`users/${username}`)
                .then(response => {
                    ...
                    var searchHistories = [];
                    // @ts-ignore
                     searchHistories = JSON.parse(localStorage.getItem("histories"))
                     console.log('searchHistories',searchHistories)
                     searchHistories = searchHistories ? searchHistories : [];
                     console.log('searchHistories',searchHistories)
                    // @ts-ignore
                    searchHistories.push(response.data);
                localStorage.setItem('histories',  JSON.stringify(searchHistories));
